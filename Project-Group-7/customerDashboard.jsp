...
out.print(customerName); %>
	...
	<form method="get" action="setAlertsForTags.jsp">
			<button type="submit" name="view item alerts"> Set Alerts for Tags</button>
			<input type="hidden" name="customerEmail" value=<%out.print(email);%>>  
	</form>
	<form method="get" action="viewCurrentAlertTags.jsp">
			<button type="submit" name="set alerts for tags"> View Tags being Alerted on</button>
			<input type="hidden" name="customerEmail" value=<%out.print(email);%>>  
	</form>
	<form method="get" action="viewItemAlerts.jsp">
			<button type="submit" name="set alerts for tags"> View Items of Interest</button>
			<input type="hidden" name="customerEmail" value=<%out.print(email);%>>  
	</form>
	<form method="get" action="viewFAQ.jsp">
			<button type="submit" name="faq"> List of FAQ</button>
			<input type="hidden" name="customerEmail" value=<%out.print(email);%>>  
	</form>
